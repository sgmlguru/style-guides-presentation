...
This is me mounting a defence for style guides, those elusive things supposedly controlling content beyond the capabilities of schemas.

Start by cd'ing into `reveal.js` and running `npm start` on the command line. Assumes you have *Reveal JS* and *npm* installed.
